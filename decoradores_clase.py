...
def decorador_repr(cls):
    ...
    #Revisamos si cada paramentro tiene un metodo property asiciado
    for parametros in parametros_init:
       ...
       es_metodo_property = isinstance(atributos.get(parametros), property)
        if not es_metodo_property:
            raise TypeError(f'No existe un metodo property para el parametro: {parametros}')
   ...
   def metodo_repr(self):
      ...
      #Lista del generador
       ...
       resultado_metodo_repr = f'{nombre_clase}({}'
...
class Persona:
    ...
    #def __repr__(self):
       #return f'Persona({self._nombre}, apellido={self._apellido})'

persona1 = Persona ('Juan', 'Perez', 28)
print(persona1)
persona2 = Persona('Karla', 'Gomez', 30)
print(persona2)
#Tiene los metodos de propiedad nombre
print(dir(Persona))
